...
interface ModelRepository : BaseRepository<Model> {
}

interface ModificationRepository : BaseRepository<Modification> {
}
...
interface QueueHistoryRepository : BaseRepository<QueueHistory> {
}
